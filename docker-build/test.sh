...
cd /home/travis/BuddySuite/buddysuite/tests
...
mv .coverage /home/travis/BuddySuite/buddysuite/tests/test_buddy_resources/

#### Buddy Resources
cd /home/travis/BuddySuite/buddysuite/tests/test_buddy_resources
TEST_SCRIPTS='test_buddy_resources.py '
py.test ${TEST_SCRIPTS} --cache-clear -p no:cacheprovider --cov --cov-append --cov-report=
mv .coverage /home/travis/BuddySuite/buddysuite/tests/test_alignbuddy/

#### AlignBuddy
cd /home/travis/BuddySuite/buddysuite/tests/test_alignbuddy
...
py.test ${TEST_SCRIPTS} --cache-clear -p no:cacheprovider --cov --cov-append --cov-report=
mv .coverage /home/travis/BuddySuite/buddysuite/tests/test_databasebuddy/

#### DatabaseBuddy
cd /home/travis/BuddySuite/buddysuite/tests/test_databasebuddy
TEST_SCRIPTS='test_db_class_and_helpers.py '
TEST_SCRIPTS+='test_db_clients.py '
TEST_SCRIPTS+='test_db_ui.py '
py.test ${TEST_SCRIPTS} --cache-clear -p no:cacheprovider --cov --cov-append --cov-report=
mv .coverage /home/travis/BuddySuite/buddysuite/tests/test_seqbuddy/

#### SeqBuddy
cd /home/travis/BuddySuite/buddysuite/tests/test_seqbuddy
...
py.test ${TEST_SCRIPTS} --cache-clear -p no:cacheprovider --cov --cov-append --cov-report=
mv .coverage /home/travis/BuddySuite/buddysuite/tests/test_phylobuddy/

#### PhyloBuddy
cd /home/travis/BuddySuite/buddysuite/tests/test_phylobuddy
