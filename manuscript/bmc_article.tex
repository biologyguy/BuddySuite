...
Whichever format is encountered last will be the format the records output in (in this case, FASTA), although this behaviour may be overridden with the `-{}-output' modifier:
...
\subsection*{DatabaseBuddy}
-------------------------------------------------------------

Not sure if this should be it's own thing... It's so different from the other modules, that maybe? 
