...
for _file in ["AlignBuddy.py", "DatabaseBuddy.py", "PhyloBuddy.py", "SeqBuddy.py", "buddy_resources.py", "__init__.py"]:
...
setup(name='buddysuite',
      ...
      zip_safe=True,
      cmdclass={'clean': CleanCommand, 'uninstall': UninstallCommand, 'remove': UninstallCommand}
      )
